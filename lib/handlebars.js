...
module.exports = function (reporter, definition) {
  if (reporter.compilation) {
    reporter.compilation.include('handlebars', require.resolve('handlebars'))
  }

  reporter.options.tasks.nativeModules.push({
    globalVariableName: 'handlebars',
    module: reporter.execution ? reporter.execution.resolve('handlebars') : path.dirname(require.resolve('handlebars'))
  })
